...
public class RegexUtils {
    ...
    static final String strWords = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";
     ...
     * @return
     */
    public static  String autoRandomString(int length) {
    ...
    public String autoRandomChar(int length) {
        ...
        for (int i = 0; i < length; i++) {
            buffer.append(Constant.BIG_KEY[random.nextInt(62)]);
        }
   ...
   /* public static boolean checkDate(String birthday) {
    ...
    public static String randomLength(int length){
